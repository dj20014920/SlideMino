...
export const SKIN_RENDER_MODES: Record<string, SkinRenderMode> = {
  ...
  skin_cute_dog: 'matte',
  skin_cute_calico_cat: 'matte',
  skin_cute_cheese_cat: 'matte',
  skin_cute_siamese_cat: 'matte',
  skin_cute_sphynx_cat: 'matte',
  skin_cute_shiba: 'matte',
  skin_cute_corgi: 'matte',
  skin_cute_retriever: 'matte',
  skin_cute_poodle: 'matte',
  skin_cute_scottish_fold: 'matte',
  skin_cute_chihuahua: 'matte',
  skin_cute_bichon: 'matte',
  skin_cute_maltese: 'matte',
};
